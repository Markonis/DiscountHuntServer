...
ActiveRecord::Schema.define(version: 20160705055243) do
  ...
  add_index "discount_votes", ["discount_id"], name: "index_discount_votes_on_discount_id", using: :btree
  add_index "discount_votes", ["user_id"], name: "index_discount_votes_on_user_id", using: :btree
  ...
  create_table "friends_rankings", force: :cascade do |t|
    t.integer  "user_id"
    t.text     "result"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_index "friends_rankings", ["user_id"], name: "index_friends_rankings_on_user_id", using: :btree
  ...
  create_table "settings", force: :cascade do |t|
    ...
    t.float    "search_radius",             default: 0.5
    t.integer  "user_id"
    t.datetime "created_at",                               null: false
    t.datetime "updated_at",                               null: false
  end
